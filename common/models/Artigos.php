 ...
 * @property float $precoFinal
 * @property int|null $stock
 * @property int $categoria_id
 * @property int $iva_id
 * @property int|null $destaque
 * @property string|null $imagem
 * @property float $precoUni
...
class Artigos extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['nome', 'descricao', 'precoFinal', 'categoria_id', 'iva_id', 'precoUni', 'referencia'], 'required'],
            [['precoFinal', 'precoUni'], 'number'],
            [['stock', 'categoria_id', 'iva_id', 'destaque'], 'integer'],
            [['nome', 'descricao', 'imagem', 'referencia'], 'string', 'max' => 45],
