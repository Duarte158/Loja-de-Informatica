            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 d-flex justify-content-center justify-content-md-start mb-3 mb-md-0"><a
                                ...
                                class="ms-md-2"> <?= Html::img('@web/favicon.ico', ['alt' => Yii::$app->name, 'style' => 'height:80px;']) ?> </a>
                    </div>
                    <!-- Left elements -->
                                    ...
                                    <div class="row my-4">
                                        <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                                            <div class="list-group list-group-flush">
                                                <a href="<?= Url::to(['artigos/artigos', 'id' => 1]) ?>" class="list-group-item list-group-item-action">Ratos</a>
